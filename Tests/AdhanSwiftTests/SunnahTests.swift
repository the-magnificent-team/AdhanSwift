...
class SunnahTests: XCTestCase {
    ...
    func testSunnahTimesNY() {
        ...
        XCTAssertEqual(dateFormatter.string(from: todayPrayers[.maghrib].prayerTime), "7/12/15, 8:32 PM")
        ...
        XCTAssertEqual(dateFormatter.string(from: tomorrowPrayers[.fajr].prayerTime), "7/13/15, 4:43 AM")
    ...
    func testSunnahTimesLondon() {
        ...
        let todayPrayers = PrayerTimes(coordinates: coordinates, date: comps1, calculationParameters: params)!
        XCTAssertEqual(dateFormatter.string(from: todayPrayers[.maghrib].prayerTime), "12/31/16, 4:04 PM")
        ...
        let tomorrowPrayers = PrayerTimes(coordinates: coordinates, date: comps2, calculationParameters: params)!
        XCTAssertEqual(dateFormatter.string(from: tomorrowPrayers[.fajr].prayerTime), "1/1/17, 6:25 AM")
    ...
    func testSunnahTimesOslo() {
        ...
        let todayPrayers = PrayerTimes(coordinates: coordinates, date: comps1, calculationParameters: params)!
        XCTAssertEqual(dateFormatter.string(from: todayPrayers[.maghrib].prayerTime), "7/1/16, 10:41 PM")
        ...
        let tomorrowPrayers = PrayerTimes(coordinates: coordinates, date: comps2, calculationParameters: params)!
        XCTAssertEqual(dateFormatter.string(from: tomorrowPrayers[.fajr].prayerTime), "7/2/16, 1:20 AM")
    ...
    func testSunnahTimesDST1() {
        ...
        let todayPrayers = PrayerTimes(coordinates: coordinates, date: comps1, calculationParameters: params)!
        XCTAssertEqual(dateFormatter.string(from: todayPrayers[.fajr].prayerTime), "3/11/17, 5:14 AM")
        XCTAssertEqual(dateFormatter.string(from: todayPrayers[.maghrib].prayerTime), "3/11/17, 6:13 PM")
        ...
        let tomorrowPrayers = PrayerTimes(coordinates: coordinates, date: comps2, calculationParameters: params)!
        XCTAssertEqual(dateFormatter.string(from: tomorrowPrayers[.fajr].prayerTime), "3/12/17, 6:13 AM")
        XCTAssertEqual(dateFormatter.string(from: tomorrowPrayers[.maghrib].prayerTime), "3/12/17, 7:14 PM")
    ...
    func testSunnahTimesDST2() {
        ...
        let todayPrayers = PrayerTimes(coordinates: coordinates, date: comps1, calculationParameters: params)!
        XCTAssertEqual(dateFormatter.string(from: todayPrayers[.fajr].prayerTime), "10/24/15, 6:38 AM")
        XCTAssertEqual(dateFormatter.string(from: todayPrayers[.maghrib].prayerTime), "10/24/15, 6:45 PM")
        ...
        let tomorrowPrayers = PrayerTimes(coordinates: coordinates, date: comps2, calculationParameters: params)!
        XCTAssertEqual(dateFormatter.string(from: tomorrowPrayers[.fajr].prayerTime), "10/25/15, 5:40 AM")
        XCTAssertEqual(dateFormatter.string(from: tomorrowPrayers[.maghrib].prayerTime), "10/25/15, 5:43 PM")
